...
export default class websocketConnection {
  ...
  async make_message(text) {
    ...
    let websocket_message = Cbor.encode({
      client_key: this.client_key, // public key generated by the client
  ...
  async onOpen(event) {
    ...
    this.client_key = await ed.getPublicKey(this.key);
    await ic_websocket_backend.ws_register(this.client_key);
    this.sequence_num = 0;
