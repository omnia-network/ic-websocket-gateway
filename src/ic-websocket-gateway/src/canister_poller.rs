...
type PollerEvents = EventsImpl<PollerEventsMetrics>;

#[derive(Debug, Clone)]
struct PollerEventsMetrics {
...
type IncomingCanisterMessageEvents = EventsImpl<IncomingCanisterMessageEventsMetrics>;

#[derive(Debug, Clone)]
struct IncomingCanisterMessageEventsMetrics {
